...
if app_mode =='About App':
    ...
    st.video('https://youtu.be/sJScvUNdpFk')
    ...
    st.markdown('''
          # About Me \n 
            ...
            - [Kaggle](https://www.kaggle.com/venkatasreeram)
            - [Portfolio](https://venkatasreeram.live)
        
            If you are feeling generous you can buy me a **cup of  coffee ** from [HERE](https://wa.me/+919573979038)
